...
public class VLinkedList<E>
     ...
     */
    public VLinkedList(Collection<? extends E> c) {
        this();
        addAll(c);
    }

    //Needed, because both List and Deque have a reversed() method, and we want to avoid the diamond problem.
    public VLinkedList<E> reversed() {
        VLinkedList<E> rev = new VLinkedList<>();
    ...
    @SuppressWarnings("unchecked")
    private VLinkedList<E> superClone() {
        try {
            return (VLinkedList<E>) super.clone();
     ...
     */
    public Object clone() {
        VLinkedList<E> clone = superClone();
    ...
    static final class LLSpliterator<E> implements Spliterator<E> {
        ...
        final VLinkedList<E> list; // null OK unless traversed
        Node<E> current; // current node; null until initialized
        int est; // size estimate; -1 until first needed
        int expectedModCount; // initialized when est set
        int batch; // batch size for splits

        LLSpliterator(VLinkedList<E> list, int est, int expectedModCount) {
            this.list = list;
            this.est = est;
